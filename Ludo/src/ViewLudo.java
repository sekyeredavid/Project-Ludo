...
public class ViewLudo extends JPanel implements Serializable,ActionListener,MouseListener, ItemListener{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -6467552098014687977L;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(obj == Save){
			...
			ViewLudo vt = SaveGame.load();
			frame.setContentPane(vt);
			vt = null;
		}
